            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "IMPORTANT: Use Markdown formatting with LaTeX math notation throughout.\n"
                        "For math, use $...$ for inline (e.g. $x^2$) and $$...$$ on its own line for display math "
                        "(e.g. $$\\frac{a}{b}$$). Use LaTeX for all fractions, exponents, roots, integrals, etc.\n\n"
                        "Provide:\n"
                        "- solution: if the extracted text contains a specific question or problem, provide the correct answer "
                        "with a clear, numbered step-by-step solution. Use one step per line. "
                        "Put each major math expression on its own line using $$...$$ display math so it's easy to read. "
                        "If it is general study material with no specific question, set this to an empty string.\n"
